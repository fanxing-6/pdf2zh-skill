    ...
    messages = [
        ...
        },
        {
            ...
            "content": (
                ...
                "Preserve the original sentence order as much as possible: do not merge, split, reorder, or summarize sentences unless the LaTeX structure makes it unavoidable. "
